<template>
  <section class="home-hero" style="background-color: #5ea85e; min-height: 100vh; padding: 2rem 2rem; display: flex; flex-direction: column;">
    <div style="width: 100%; max-width: 100%; margin: 0 auto; display: flex; flex-direction: column; align-items: center; flex-grow: 1; height: 100%;">
      ...
      <!-- Content Area -->
      <div style="width: 100%; display: flex; justify-content: flex-start; align-items: flex-start; margin-top: 2rem;">
        <!-- Left Text Content -->
        <div style="width: 40%; max-width: 500px;">
          <h1 style="
            font-size: 2.5rem;
            font-weight: 700;
